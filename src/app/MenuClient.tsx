          ...
          {data.restaurants.map((restaurant) => (
            ...
            >
              {restaurant.imageUrl ? (
                ...
                <img src={restaurant.imageUrl} alt={rtl ? restaurant.nameAr : restaurant.nameEn} className="h-24 w-full object-cover" loading="lazy" />
              ) : (
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              {category.items.map((item) => (
                ...
                >
                  {item.imageUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img src={item.imageUrl} alt={rtl ? item.nameAr : item.nameEn} className="h-36 w-full rounded-lg object-cover" loading="lazy" />
                  ) : null}
